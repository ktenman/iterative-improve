...
ALLOWED_IMPORTS = {
    ...
    "color": set(),
    "config": {"improve.ci", "improve.ci_gh"},
    "runner": {
        "improve",
        "improve.ci",
        "improve.claude",
    ...
    "claude": {"improve.config", "improve.process"},
    "codex": {"improve.config", "improve.process"},
    "council": {
        "improve",
        "improve.config",
        "improve.council_prompts",
        "improve.findings",
        "improve.phases",
        "improve.rounds",
        "improve.state",
    },
    "council_prompts": {"improve.findings", "improve.phases"},
    "rounds": {"improve.council_prompts", "improve.findings", "improve.process"},
    "findings": set(),
    "ci": {"improve.config", "improve.process"},
    "ci_gh": {"improve.ci", "improve.process"},
    "ci_glab": {"improve.ci", "improve.process"},
    "mode": set(),
    "platform": set(),
    "git": {"improve.claude", "improve.platform", "improve.process", "improve.phases"},
    "process": set(),
    "phases": set(),
